...
CACHES = {
    "default": {
        ...
        "OPTIONS": {
            ...
            "IGNORE_EXCEPTIONS": True,  # never let a cache outage 500 the API
        },
...
STORAGES = {
    ...
    "staticfiles": {
        # Hashed + compressed manifest in production; plain storage in dev so
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Wikiverse API",
    "DESCRIPTION": "A modern, open encyclopedia API — articles, revisions, "
